...
export const SLOT_CONFIGS: Record<string, SlotConfig> = {
  'classic-777': {
    ...
    rtp: 95.8,
    symbols: [
      { glyph: '🍋', weight: 30, payout: 11 },
      { glyph: '🍇', weight: 26, payout: 16 },
      { glyph: '🍒', weight: 22, payout: 22 },
      { glyph: '🔔', weight: 14, payout: 43 },
      { glyph: '⭐', weight: 6, payout: 110 },
      { glyph: '7', weight: 2, payout: 415 },
    ],
  },
  'golden-pharaoh': {
    id: 'golden-pharaoh',
    rtp: 96.7,
    symbols: [
      { glyph: '📜', weight: 30, payout: 10 },
      { glyph: '🏺', weight: 25, payout: 14 },
      { glyph: '🐫', weight: 20, payout: 29 },
      { glyph: '🐍', weight: 14, payout: 57 },
      { glyph: '👁️', weight: 8, payout: 145 },
      { glyph: '👑', weight: 3, payout: 570 },
    ],
  },
  'neon-diamonds': {
    id: 'neon-diamonds',
    rtp: 94.3,
    symbols: [
      { glyph: '🔷', weight: 32, payout: 8 },
      { glyph: '⚡', weight: 24, payout: 16 },
      { glyph: '🪙', weight: 20, payout: 29 },
      { glyph: '🎰', weight: 13, payout: 62 },
      { glyph: '💠', weight: 8, payout: 145 },
      { glyph: '💎', weight: 3, payout: 620 },
    ],
  },
  'wild-safari': {
    id: 'wild-safari',
    rtp: 95.8,
    symbols: [
      { glyph: '🦓', weight: 30, payout: 9 },
      { glyph: '🐘', weight: 25, payout: 17 },
      { glyph: '🦒', weight: 20, payout: 26 },
      { glyph: '🐆', weight: 14, payout: 61 },
      { glyph: '🦍', weight: 8, payout: 120 },
      { glyph: '🦁', weight: 3, payout: 475 },
    ],
  },
  'pirates-gold': {
    id: 'pirates-gold',
    rtp: 95.0,
    symbols: [
      { glyph: '⚓', weight: 30, payout: 8 },
      { glyph: '🦜', weight: 25, payout: 16 },
      { glyph: '🗺️', weight: 20, payout: 28 },
      { glyph: '☠️', weight: 14, payout: 65 },
      { glyph: '🧭', weight: 8, payout: 130 },
      { glyph: '💰', weight: 3, payout: 565 },
    ],
  },
  'fruit-fiesta': {
    id: 'fruit-fiesta',
    ...
    symbols: [
      { glyph: '🍌', weight: 30, payout: 10 },
      { glyph: '🍓', weight: 26, payout: 15 },
      { glyph: '🍍', weight: 21, payout: 26 },
      { glyph: '🥝', weight: 14, payout: 46 },
      { glyph: '🍉', weight: 7, payout: 125 },
      { glyph: '✨', weight: 2, payout: 460 },
    ],
  },
}
